...
export function createPoolWater(a, b, geometryOverride = null) {
  ...
  const uniforms = {
    ...
    absorptionStrength: { value: 0.08 },

    // Shallow/deep look controls
    shallowColor: { value: new THREE.Color(0.78, 0.96, 1.0) }, // brighter aqua
    deepColor:    { value: new THREE.Color(0.70, 0.90, 0.98) }, // dark

    alphaShallow: { value: 0.18 },
    alphaDeep:    { value: 0.24 },

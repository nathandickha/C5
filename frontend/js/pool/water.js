...
export function createPoolWater(a, b, geometryOverride = null) {
  ...
  const uniforms = {
    ...
    absorptionStrength: { value: 0.04 },

    // Shallow/deep look controls
    shallowColor: { value: new THREE.Color(0.86, 0.98, 1.0) }, // brighter aqua
    deepColor:    { value: new THREE.Color(0.84, 0.96, 1.0) }, // dark

    alphaShallow: { value: 0.14 },
    alphaDeep:    { value: 0.18 },

    // UV fallback depth (meters-ish thickness)
    thicknessShallow: { value: 0.55 },
    thicknessDeep:    { value: 0.55 },

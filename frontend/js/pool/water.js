...
export function createPoolWater(a, b, geometryOverride = null) {
  ...
  const uniforms = {
    ...
    absorption: { value: new THREE.Color(1.10, 0.62, 0.28) },
    absorptionStrength: { value: 0.07 },

    // Shallow/deep look controls
    shallowColor: { value: new THREE.Color(0.64, 0.97, 1.0) }, // brighter aqua
    deepColor:    { value: new THREE.Color(0.10, 0.46, 0.96) }, // dark

    alphaShallow: { value: 0.16 },
    alphaDeep:    { value: 0.28 },

...
const TILE_LIBRARY_OPTIONS = [
  { key: "blue", label: "Blue", folder: "blue" },
  { key: "black", label: "Black", folder: "black" },
  { key: "white", label: "White", folder: "white" },
  { key: "Antique Opal", label: "Antique Opal", folder: "Antique Opal" },
  { key: "Aqua Glass", label: "Aqua Glass", folder: "Aqua Glass" },
  { key: "Arctic Blue", label: "Arctic Blue", folder: "Arctic Blue" },
  { key: "Cobalt Blue", label: "Cobalt Blue", folder: "Cobalt Blue" },
  { key: "Deep Ocean", label: "Deep Ocean", folder: "Deep Ocean" },
  { key: "Lagoon", label: "Lagoon", folder: "Lagoon" },
  { key: "Turquoise", label: "Turquoise", folder: "Turquoise" },
  { key: "Emerald", label: "Emerald", folder: "Emerald" },
  { key: "Seafoam", label: "Seafoam", folder: "Seafoam" },
  { key: "Pearl", label: "Pearl", folder: "Pearl" },
  { key: "Silver Grey", label: "Silver Grey", folder: "Silver Grey" },
  { key: "Graphite", label: "Graphite", folder: "Graphite" },
  { key: "Midnight", label: "Midnight", folder: "Midnight" },
  { key: "Sandstone", label: "Sandstone", folder: "Sandstone" },
  { key: "Travertine", label: "Travertine", folder: "Travertine" },
  { key: "Jade", label: "Jade", folder: "Jade" },
  { key: "Opal Blue", label: "Opal Blue", folder: "Opal Blue" }
];
...
function createStage3SupportTextureSet(baseTex, tileKey = "tile") {
  ...
  try {
    ...
    const groutWidth = TILE_GROUT_WIDTH * 1.08;
    const bevelWidth = groutWidth * 2.8;
...
export class PBRManager {
  ...
  renderTileSelector() {
    ...
    TILE_LIBRARY_OPTIONS.forEach((tile) => {
      ...
      const previewUrl = new URL(
        `../../../pbr_tiles/${encodePathSegmentPath(tile.folder)}/preview.jpg`,
        import.meta.url
      ).href;
  ...
  async ensureTileLoaded(tileKey) {
    ...
    const stage3Maps = createStage3SupportTextureSet(enhancedMap || map, tileKey);
    const maps = {
      map: enhancedMap,

...
export class PBRManager {
  ...
  buildTileMaterial(maps, mesh, surfaceKind = "default") {
    ...
    const tintConfigBySurface = {
      floor: {
        shallowMultiplier: new THREE.Vector3(0.94, 1.03, 1.10),
        deepMultiplier: new THREE.Vector3(0.48, 0.78, 1.18),
        shallowAmount: 0.14,
        deepAmount: 0.58,
        brighten: 0.065
      },
      wall: {
        shallowMultiplier: new THREE.Vector3(0.96, 1.02, 1.08),
        deepMultiplier: new THREE.Vector3(0.62, 0.84, 1.14),
        shallowAmount: 0.10,
        deepAmount: 0.40,
        brighten: 0.058
      },
      step: {
        shallowMultiplier: new THREE.Vector3(0.95, 1.025, 1.09),
        deepMultiplier: new THREE.Vector3(0.70, 0.90, 1.11),
        shallowAmount: 0.12,
        deepAmount: 0.28,
        brighten: 0.05
      },
      spa: {
        shallowMultiplier: new THREE.Vector3(0.95, 1.025, 1.09),
        deepMultiplier: new THREE.Vector3(0.62, 0.83, 1.13),
        shallowAmount: 0.12,
        deepAmount: 0.40,
        brighten: 0.0356
      },
    ...
    mat.onBeforeCompile = (shader) => {
      ...
      const poolTintFragmentChunk = [
        ...
        "vec3 waterBodyColour = mix(vec3(0.55, 0.98, 1.0), vec3(0.02, 0.32, 0.92), poolDepthTintFactor);",
        "tintedPoolColour = mix(tintedPoolColour, waterBodyColour, clamp(poolTintAmount * 0.18, 0.0, 0.16));",

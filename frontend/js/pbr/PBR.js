...
export class PBRManager {
  ...
  buildTileMaterial(maps, mesh, surfaceKind = "default") {
    ...
    // the underwater tile material based on world height. The tint preserves
    // tile colour and detail while still making the depth change clearly visible.
    const tintConfigBySurface = {
      floor: {
        shallowMultiplier: new THREE.Vector3(0.99, 1.01, 1.03),
        deepMultiplier: new THREE.Vector3(0.76, 0.90, 1.08),
        shallowAmount: 0.06,
        deepAmount: 0.32,
        brighten: 0.045
      },
      wall: {
        shallowMultiplier: new THREE.Vector3(0.995, 1.005, 1.02),
        deepMultiplier: new THREE.Vector3(0.84, 0.94, 1.06),
        shallowAmount: 0.04,
        deepAmount: 0.22,
        brighten: 0.022
      },
      step: {
        shallowMultiplier: new THREE.Vector3(0.99, 1.01, 1.025),
        deepMultiplier: new THREE.Vector3(0.88, 0.96, 1.05),
        shallowAmount: 0.05,
        deepAmount: 0.16,
        brighten: 0.03
      },
      spa: {
        shallowMultiplier: new THREE.Vector3(0.99, 1.01, 1.025),
        deepMultiplier: new THREE.Vector3(0.83, 0.93, 1.06),
        shallowAmount: 0.05,
        deepAmount: 0.22,
        brighten: 0.026
      },
...
vPoolTileWorldPos = poolTileWorldPosition.xyz;'
      ...
      shader.fragmentShader = `uniform vec3 uPoolTintShallowMultiplier;
...
tintedPoolColour += vec3(0.02, 0.03, 0.04) * poolShallowLift;
